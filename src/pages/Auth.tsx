...
const Auth = () => {
  ...
  return <div className="min-h-screen flex items-center justify-center px-4 py-12">
      <Card className="w-full max-w-md p-8">
        <h1 className="text-3xl font-bold text-center mb-8 text-gradient">The Lock Room</h1>
          ...
          <TabsContent value="signup">
            <form onSubmit={handleSignUp} className="space-y-4">
              ...
              <div>
                ...
                <Input id="signup-phone" type="tel" value={signUpData.phoneNumber} onChange={e => setSignUpData({
                ...signUpData,
